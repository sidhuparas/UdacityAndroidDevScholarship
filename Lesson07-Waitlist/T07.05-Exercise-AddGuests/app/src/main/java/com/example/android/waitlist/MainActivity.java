...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mNewGuestName, mNewPartySize;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuestName = (EditText) findViewById(R.id.person_name_edit_text);
        mNewPartySize = (EditText) findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        if (mNewGuestName.getText().length()==0 ||
                mNewPartySize.getText().length()==0){
            return;
        }
        ...
        try {
            partySize = Integer.parseInt(mNewPartySize.getText().toString());
        }catch (Exception e){
            Log.e("partySizeError", "addToWaitlist: " + e.getMessage());
        }
        ...
        addGuest(mNewGuestName.getText().toString(), partySize);
        ...
        mNewPartySize.getText().clear();
        mNewGuestName.getText().clear();
        mNewPartySize.clearFocus();
    }
