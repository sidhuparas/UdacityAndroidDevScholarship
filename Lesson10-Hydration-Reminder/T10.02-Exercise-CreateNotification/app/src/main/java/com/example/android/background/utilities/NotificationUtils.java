...
public class NotificationUtils {
    private static final String NOTIF_CHANNEL_ID = "10";
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        if (Build.VERSION.SDK_INT >=26){
            NotificationChannel notificationChannel = new NotificationChannel(
                    NOTIF_CHANNEL_ID,"Reminder",NotificationManager.IMPORTANCE_DEFAULT);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(
                context,NOTIF_CHANNEL_ID);
        builder.setColor(ContextCompat.getColor(context,R.color.colorPrimary))
                .setSmallIcon(R.drawable.ic_drink_notification)
                .setLargeIcon(largeIcon(context))
                .setContentTitle(res.getString(R.string.charging_reminder_notification_title))
                .setContentText(res.getString(R.string.charging_reminder_notification_body))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        res.getString(R.string.charging_reminder_notification_body)))
    ...
    public static final int PENDING_INTENT_ID = 2;
